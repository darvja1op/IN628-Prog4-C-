...
Sprite::Sprite(Graphics^ startCanvas, array<String^>^ startFileNames, Random^ startRGen, int startNFrames, Rectangle startBoundingArea, double startProportionReduction)
{
	canvas = startCanvas;
	...
	ProportionReduction = startProportionReduction;
